...
class Evolution:
    ...
    def next_population_selection(self, players, num_players):
        ...
        #max = sum([c.fitness for c in players])
        #selection_probs = [c.fitness/max for c in players]
        #print("llllllllllllllllllll", len(players[npr.choice(num_players, p=selection_probs)]))
        #return players[npr.choice(num_players, p=selection_probs)]
